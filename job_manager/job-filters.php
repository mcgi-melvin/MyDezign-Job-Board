...
<form class="job_filters">
	...
	<div class="search_jobs">
		...
		<div class="search_keywords search_field">
		...
		<div class="search_location search_field">
		...
		<?php elseif ( $show_categories && ! is_tax( 'job_listing_category' ) && get_terms( array( 'taxonomy' => 'job_listing_category' ) ) ) : ?>
			<div class="search_categories category_field search_field">
		...
		<?php endif; ?>
		<div class="search_categories salary_field search_field">
		...
		?>
			<div class="search_submit">
				<input class="btn btn-info" type="submit" value="<?php esc_attr_e( 'Search Jobs', 'wp-job-manager' ); ?>">
			</div>
		<?php endif; ?>
