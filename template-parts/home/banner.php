...
<div id="JEPH_banner" class="banner" style="background-image: url(<?php echo $bg_link; ?>);">
    <div class="home-box text-center">
      ...
      <?php endif; ?>
      <form method="GET" action="<?php echo site_url('/'.apply_filters('get_template_url', 'page-joblist.php')[0]->post_name); ?>" autocomplete="off">
        <input type="text" name="q" placeholder="Search Keyword" required />
        <input class="text-uppercase" type="submit" value="Search" />
      </form>
