...
function update() {
  ...
  _projection.refZ = 1920;
  _projection.fLength = 400;
...
function render() {
  ...
  context.beginPath();
  context.fillStyle = 'transparent'; // Leave blank
  context.lineWidth = 5;
  context.arc(
    canvas.width/2,
    canvas.height/2,
...
function createCircle() {
  ...
  this.render = function() {
    context.beginPath();
    context.strokeStyle = 'rgba(120, 201, 230, ' + (this.shape.posZ * -1) / 60 + ')';
    context.fillStyle = 'rgba(120, 201, 230, ' + (this.shape.posZ * -1) / 60 + ')';
